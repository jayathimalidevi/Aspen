...
' . $extra
    ...
    <div class="detail-grid">
        ...
        <aside class="detail-sidebar">
            <div class="sidebar-card sidebar-apply">
                <div class="sidebar-card-title">Ready to Apply?</div>
                <a href="' . e($permalink) . '" class="apply-btn" rel="nofollow noopener" target="_blank">Apply Now</a>
                <p class="sidebar-apply-note">No account needed &bull; Direct application</p>
            </div>
            <div class="sidebar-card">
                <div class="sidebar-card-title">Job Details</div>
                <div class="sidebar-detail-list">
                    <div class="sidebar-detail-item">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
                        <div><div class="sidebar-detail-label">Location</div><div class="sidebar-detail-value">Remote &bull; ' . e($country['name']) . '</div></div>
                    </div>
                    <div class="sidebar-detail-item">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/></svg>
                        <div><div class="sidebar-detail-label">Type</div><div class="sidebar-detail-value">Full-time</div></div>
                    </div>
                    <div class="sidebar-detail-item">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12,6 12,12 16,14"/></svg>
                        <div><div class="sidebar-detail-label">Posted</div><div class="sidebar-detail-value">' . e($postedLabel) . '</div></div>
                    </div>
                </div>
            </div>
        </aside>
